import { GET_BACKLINK_FROM_MISTERGOODLINK_URL } from '@/global/marketplaceUrls';
import PQueue from 'p-queue';
import { fetchDataFromMistergoodlink } from '../fetchDataFromMarketplaces/mistergoodlink';
