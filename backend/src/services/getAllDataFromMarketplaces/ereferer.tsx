...
import { fetchDataFromEreferer } from '../fetchDataFromMarketplaces/ereferer';
import { GET_BACKLINK_FROM_Ereferer_URL } from '@/global/marketplaceUrls';
...
export const getAllDataFromEreferer = async (cookie: string) => {
  if (!cookie) {
