import { Mistergoodlink_API_URL } from '@/global/marketplaceUrls';
...
export const getCookieFromMistergoodlink = async (): Promise<string | null> => {
  ...
  for (const credential of credentials) {
    ...
    const hasMistergoodlinkTarget = credential.websiteTarget.some(target => target.value === 'Mistergoodlink');
